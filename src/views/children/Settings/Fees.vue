      ...
      <form @submit.prevent="submit">
        <div class="row">
          ...
          <base-input
            col="6"
            type="number"
            :placeholder="$t('labels.application_fees')"
            v-model="data.application_fees"
          />
          ...
          <base-input
            col="6"
            type="number"
            :placeholder="$t('labels.delivery_charge')"
            v-model="data.delivery_charge"
          />
          ...
          <base-input
            col="6"
            type="number"
            :placeholder="$t('labels.tracking_fees')"
            v-model="data.tracking_fees"
          />
          ...
          <base-input
            col="6"
            type="number"
            :placeholder="$t('labels.tax_fees')"
            v-model="data.tax_fees"
            icon="mdi-percent"
            append-icon
          />

          <!-- ***** ownership_transfer_fees -->
          <base-input
            col="6"
            type="number"
            :placeholder="$t('labels.ownership_transfer_fees')"
            v-model="data.ownership_transfer_fees"
          />
          ...
          <base-input
            col="6"
            type="number"
            :placeholder="$t('labels.price_percentage')"
            v-model="data.price_percentage"
            icon="mdi-percent"
            append-icon
          />
