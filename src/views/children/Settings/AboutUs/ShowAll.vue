  ...
  <div class="countries_all">
    <template>
      ...
      <Breadcrumb
        ...
        :search_title="$t('breadcrumb.about.add')"
        icon="fa-plus"
      />
          ...
          <template v-slot:top>
            <h3 class="table-title title">
              ...
              <v-tooltip bottom>
                ...
                <span> {{ $t("breadcrumb.about.all") }}</span>
              </v-tooltip>
            </h3>
            <!-- Delete dialog -->
...
export default {
  ...
  created() {
    this.canEdit = this.$permission.allowed("update-about");
    this.canDelete = this.$permission.allowed("delete-about");
    this.canAdd = this.$permission.allowed("create-about");
    this.canShow = this.$permission.allowed("show-about");
    this.canShowAll = this.$permission.allowed("index-about");
