      ...
      <main>
        ...
        >
          ...
          <template v-slot:[`item.actions`]="">
            <div class="_actions">
              <v-icon class="edit" v-if="!canEdit" small @click="editItem()">
                fal fa-edit
              </v-icon>
              <!-- <deleter
                :items="rows"
          ...
          <template v-slot:top>
            <h3 class="table-title title">
              {{ $t("breadcrumb.home_slider.title") }}
...
export default {
  data() {
    return {
      items: [
        ...
        {
          text: this.$t("breadcrumb.home_slider.all"),
          disabled: true,
          href: "",
        },
      ],
  ...
  methods: {
    ...
    editItem() {
      this.$router.push({ path: `/home_slider/edit` });
    },
  ...
  created() {
    this.canEdit = this.$permission.allowed("home_slider/edit/");
    this.setRows();
  },
};
</script>
