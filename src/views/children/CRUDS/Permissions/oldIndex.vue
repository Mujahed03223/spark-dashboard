  ...
  <div class="wrraper">
    ...
    <main>
      ...
      >
        ...
        <template v-slot:[`item.permission_category`]="{ item }">
          <span>{{ item[$i18n.locale].name }}</span>
        </template>
...
export default {
  data() {
    return {
      ...
      permissionRowHeaders: [
        ...
        {
          text: this.$t("labels.is_side_show"),
          value: "show_in_side_bar",
          align: "center",
        },
        {
          text: this.$t("labels.is_control_permissions"),
          value: "is_control_permission",
          align: "center",
        },
        {
          text: this.$t("labels.icon"),
  ...
  // ======= hooks
  created() {
    this.canEdit = this.$permission.allowed("permissions/edit/");
    this.canDelete = this.$permission.allowed("permissions/delete");
    this.canAdd = this.$permission.allowed("permissions/add");
    if (this.$route.query.page) {
      this.paginations.current_page = +this.$route.query.page;
    }
    // Set Rows
