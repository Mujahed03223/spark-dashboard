<template>
  ...
  <div v-else>
    ...
    <div class="form countryForm custom_card fadeIn" v-else>
      <ValidationObserver ref="formcancelReasons" @submit.prevent="submit">
        <div class="row">
...
export default {
  ...
  data() {
    return {
      items: [
        ...
        {
          text: this.$t(`breadcrumb.cancelReasons.${this.id ? "edit" : "add"}`),
          disabled: true,
          href: "",
        },
      ],
  ...
  methods: {
    ...
    // Submit
    submit() {
      this.$refs.formcancelReasons.validate().then((d) => {
        if (d) {
          ...
          data.append("for", this.data.type.id);
          ...
          this.axios({
            ...
            .then(() => {
              ...
              this.$router.push("/cancelReasons/show-all");
