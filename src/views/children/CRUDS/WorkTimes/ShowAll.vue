  ...
  <div class="wrraper">
    ...
    <template>
      <Breadcrumb
        :canAddNew="!canAdd"
        :items="items"
        search_route="/workTimes/add"
        :search_title="$t('breadcrumb.workTimes.add')"
        icon="fa-plus"
      />
          ...
          <main>
            ...
            >
              ...
              <template v-slot:[`item.is_active`]="{ item }">
                <!-- <switcher :disabled="canEdit" name="workTimes" :item="item" value="is_active" type="active" /> -->
                <span
                  class="status pt-2"
              ...
              <template v-slot:top>
                <h3 class="table-title title">
                  ...
                  <v-tooltip bottom>
                    ...
                    <span> {{ $t("breadcrumb.workTimes.all") }}</span>
                  </v-tooltip>
                </h3>
              </template>
              <!-- ======================== End Top Section ======================== -->
...
export default {
  data() {
    return {
      ...
      items: [
        ...
        {
          text: this.$t("breadcrumb.workTimes.title"),
          disabled: false,
          href: "/workTimes/show-all",
        },
        {
          text: this.$t("breadcrumb.workTimes.all"),
          disabled: true,
          href: "",
        },
      ],
  ...
  methods: {
    ...
    showItem(item) {
      this.$router.push({ path: `/workTimes/show/` + item.id });
    },
    editItem(item) {
      this.$router.push({ path: `/workTimes/edit/` + item.id });
    },
  ...
  created() {
    ...
    this.canEdit = this.$permission.allowed("workTimes/edit/");
    this.canDelete = this.$permission.allowed("workTimes/delete");
    this.canAdd = this.$permission.allowed("workTimes/add");

    this.canShow = this.$permission.allowed("workTimes/show/");
    if (this.$route.query.page) {
      this.paginations.current_page = +this.$route.query.page;
    }
    this.setRows();
