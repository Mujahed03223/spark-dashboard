<template>
  <div class="advertisements_all">
    <template>
      ...
      <the-filter :inputs="inputs" :status="adStatus" />
      ...
      <main>
        ...
        >
          ...
          <template v-slot:[`item.is_coming`]="{ item }">
            ...
            <span class="status pt-2" :class="item.is_coming ? 'active' : 'inactive'">
        ...
        <div class="form countryForm custom_card fadeIn">
          ...
          >
            <div class="row">
              ...
              <div class="button_section d-flex gap-1 justify-content-center mt-10 mb-5">
                <v-btn
                  type="submit"
                  :loading="isLoading"
...
export default {
  data() {
    return {
      ...
      adStatus: [
        ...
        {
          id: "admin_approved_bank_transfer",
          name: this.$t(`status.admin_approved_bank_transfer`),
        },
        {
          id: "admin_approved_ownership",
          name: this.$t(`status.admin_approved_ownership`),
        },
        {
          id: "finished",
  ...
  methods: {
    ...
    handleAcceptReject(status, id) {
      ...
      if (status === "refuse-ads") {
        this.data.refuse_reason && data.append("refuse_reason", this.data.refuse_reason);
      }
      this.axios({
        method: "POST",
        url: `${status}/${id}`,
  ...
  created() {
    ...
    this.canShowAll = this.$permission.allowed("advertisements/show-all");
