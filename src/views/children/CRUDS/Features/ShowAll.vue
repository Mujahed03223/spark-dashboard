  ...
  <div class="wrraper">
    ...
    <template>
      <Breadcrumb
        ...
        :search_title="$t('breadcrumb.features.add')"
        icon="fa-plus"
      />
              ...
              <template v-slot:top>
                <h3 class="table-title title">
                  ...
                  <v-tooltip bottom>
                    ...
                    <span> {{ $t("breadcrumb.features.all") }}</span>
                  </v-tooltip>
                </h3>
              </template>
              <!-- ======================== End Top Section ======================== -->
...
export default {
  ...
  created() {
    ...
    this.canEdit = this.$permission.allowed("features/edit/");
    this.canDelete = this.$permission.allowed("features/delete");
    this.canAdd = this.$permission.allowed("features/add");

    this.canShow = this.$permission.allowed("features/show/");
    if (this.$route.query.page) {
      this.paginations.current_page = +this.$route.query.page;
    }
    this.setRows();
