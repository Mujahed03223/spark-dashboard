          ...
          <main>
            ...
            >
              ...
              <template v-slot:[`item.status`]="{ item }">
                <!-- <switcher :disabled="canEdit" name="terms" :item="item" value="is_active" type="active" /> -->
                <span
                  class="status pt-2"
...
export default {
  ...
  created() {
    ...
    this.canEdit = this.$permission.allowed("terms/edit/");
    this.canDelete = this.$permission.allowed("terms/delete");
    this.canAdd = this.$permission.allowed("terms/add");

    this.canShow = this.$permission.allowed("terms/show/");
    if (this.$route.query.page) {
      this.paginations.current_page = +this.$route.query.page;
    }
    this.setRows();
