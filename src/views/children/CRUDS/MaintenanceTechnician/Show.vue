      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xl-12">
          <div>
            ...
            <TablesOrders :profileData="profileData" name="agents" />
          </div>
        </div>
      </div>
    </div>
...
<script>
import TablesOrders from "@/components/Pages/Profile/Tables/Orders.vue";
import Profile from "@/components/Pages/Profile/Profile.vue";
export default {
  props: ["id"],
  components: { Profile, TablesOrders },
  data() {
    return {
      items: [
        {
        ...
        {
          text: this.$t(`breadcrumb.maintenanceTechnician.show`),
          disabled: true,
          href: "",
        },
      ],
