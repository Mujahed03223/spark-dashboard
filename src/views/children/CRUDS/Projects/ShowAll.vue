  ...
  <div class="wrraper">
    ...
    <template>
      <Breadcrumb
        :canAddNew="!canAdd"
        :items="items"
        search_route="/projects/add"
        :search_title="$t('breadcrumb.projects.add')"
        icon="fa-plus"
      />
              ...
              <template v-slot:top>
                <h3 class="table-title title">
                  ...
                  <v-tooltip bottom>
                    ...
                    <span> {{ $t("breadcrumb.projects.all") }}</span>
                  </v-tooltip>
                </h3>
              </template>
              <!-- ======================== End Top Section ======================== -->
...
export default {
  data() {
    return {
      ...
      items: [
        ...
        {
          text: this.$t("breadcrumb.projects.all"),
          disabled: true,
          href: "",
        },
      ],
  ...
  methods: {
    ...
    editItem(item) {
      this.$router.push({ path: `/projects/edit/` + item.id });
    },
  ...
  created() {
    ...
    this.canEdit = this.$permission.allowed("projects/edit/");
    this.canDelete = this.$permission.allowed("projects/delete");
    this.canAdd = this.$permission.allowed("projects/add");

    this.canShow = this.$permission.allowed("projects/show/");
    if (this.$route.query.page) {
      this.paginations.current_page = +this.$route.query.page;
    }
    this.setRows();
