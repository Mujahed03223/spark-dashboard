  ...
  <div class="wrraper">
    ...
    <template>
      ...
      <Breadcrumb
        :canAddNew="!canAdd"
        :items="items"
        search_route="/report-reason/add"
        :search_title="$t('breadcrumb.reportReason.add')"
        icon="fa-plus"
      />
        ...
        <div class="">
          <main>
            ...
            >
              ...
              <template v-slot:[`item.arName`]="{ item }">
                <span v-if="item.ar.name">
                  {{ item.ar.name }}
                </span>
              ...
              <template v-slot:[`item.enName`]="{ item }">
                <span v-if="item.en.name">
                  {{ item.en.name }}
                </span>
                <span class="redColor fontBold" v-else>{{
                  $t("notFound")
              ...
              <template v-slot:top>
                <h3 class="table-title title">
                  {{ $t("breadcrumb.reportReason.title") }}
                  ...
                  <v-tooltip bottom>
                    ...
                    <span> {{ $t("breadcrumb.reportReason.all") }}</span>
                  </v-tooltip>
                </h3>
                <!-- Delete dialog -->
...
export default {
  data() {
    return {
      ...
      items: [
        ...
        {
          text: this.$t("breadcrumb.reportReason.all"),
          disabled: true,
          href: "",
        },
      ],
  ...
  methods: {
    ...
    editItem(item) {
      this.$router.push({ path: `/report-reason/edit/` + item.id });
    },
