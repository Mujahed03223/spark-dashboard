<template>
  <div class="languages_all">
    <template>
      <!-- @filterFired="filterFired" -->
      <Breadcrumb
        :items="items"
        :canAddNew="!canAdd"
        search_route="/languages/add"
        :search_title="$t('breadcrumb.languages.add')"
        icon="fa-plus"
      />
      ...
      <main>
        ...
        >
          ...
          <template v-slot:[`item.name`]="{ item }">
            <span v-if="item[$i18n.locale].name">
          ...
          <template v-slot:top>
            <h3 class="table-title title">
              ...
              <v-tooltip bottom>
                ...
                <span> {{ $t("breadcrumb.languages.all") }}</span>
              </v-tooltip>
            </h3>
            <!-- Delete dialog -->
...
export default {
  data() {
    return {
      items: [
        ...
        {
          text: this.$t("breadcrumb.languages.all"),
          disabled: true,
          href: "",
        },
      ],
  ...
  methods: {
    ...
    // ==================== Start CRUD ====================
    addItem() {
      this.$router.push({ path: `/languages/add` });
    },
    showItem(item) {
      this.$router.push({ path: `/languages/show/` + item.id });
    },
    editItem(item) {
      this.$router.push({ path: `/languages/edit/` + item.id });
    },
