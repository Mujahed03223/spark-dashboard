...
export default {
  ...
  methods: {
    ...
    showItem(item) {
      this.$router.push({ path: `/users/show/` + item.id + "/cards" });
    },
    editItem(item) {
  ...
  created() {
    ...
    this.canEdit = this.$permission.allowed("users/edit");
    this.canDelete = this.$permission.allowed("users/delete");
    this.canAdd = this.$permission.allowed("users/add");
    this.canShow = this.$permission.allowed("users/show");
    this.canShowAll = this.$permission.allowed("users/show-all");
