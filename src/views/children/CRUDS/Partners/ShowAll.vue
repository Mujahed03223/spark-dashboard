  ...
  <div class="wrraper">
    ...
    <template>
      <Breadcrumb
        :canAddNew="!canAdd"
        :items="items"
        search_route="/partners/add"
        :search_title="$t('breadcrumb.partners.add')"
        icon="fa-plus"
      />
              ...
              <template v-slot:top>
                <h3 class="table-title title">
                  ...
                  <v-tooltip bottom>
                    ...
                    <span> {{ $t("breadcrumb.partners.all") }}</span>
                  </v-tooltip>
                </h3>
              </template>
              <!-- ======================== End Top Section ======================== -->
...
export default {
  data() {
    return {
      ...
      items: [
        ...
        {
          text: this.$t("breadcrumb.partners.all"),
          disabled: true,
          href: "",
        },
      ],
  ...
  methods: {
    ...
    editItem(item) {
      this.$router.push({ path: `/partners/edit/` + item.id });
    },
  ...
  created() {
    ...
    this.canEdit = this.$permission.allowed("partners/edit/");
    this.canDelete = this.$permission.allowed("partners/delete");
    this.canAdd = this.$permission.allowed("partners/add");

    this.canShow = this.$permission.allowed("partners/show/");
    if (this.$route.query.page) {
      this.paginations.current_page = +this.$route.query.page;
    }
    this.setRows();
